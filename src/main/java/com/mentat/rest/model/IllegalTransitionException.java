...
public final class IllegalTransitionException extends Exception {
    ...
    public IllegalTransitionException(Integer gameId, Integer doorId, DoorStatus from, DoorStatus to) {
        super(String.format(DOOR_TRANSITION_FROM_TO_MESSAGE_FORMAT, doorId, gameId, from, to));
    }

    public IllegalTransitionException(Integer gameId, Integer doorId, DoorStatus to) {
        super(String.format(DOOR_TRANSITION_TO_MESSAGE_FORMAT, doorId, gameId, to));
    }

    public IllegalTransitionException(Integer gameId, GameStatus from, GameStatus to) {
